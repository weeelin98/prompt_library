...
A curated collection of practical prompts, translated and refined in English for clarity, consistency, and reuse.
...
- Optional usage notes, placeholders, or examples
- Relevant tags for easier discovery

The category structure will grow as new prompts are added.

## Contributing

Suggestions and improvements are welcome. When adding a prompt, keep it focused, reusable, and easy to customize.
